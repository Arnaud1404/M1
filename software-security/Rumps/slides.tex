...
\begin{frame}{Architecture : Chiffrement par flot}
    ...
    Le plaintext $m_t$ est chiffré bit à bit avec la suite chiffrante $z_t$ :
...
\begin{frame}{La Solution : Générateur à Combinaison}
    ...
    \note{
        ...
        - Sécurité : Repose sur l'impossibilité d'isoler un registre via la suite chiffrante.
    }
\end{frame}
...
\begin{frame}{L'Attaque : \textit{Divide \& Conquer}}
    ...
    \vspace{0.4cm}
    \textbf{Méthode :} Avec du \textit{plaintext probable} (en-tête diplomatique, salutation standard), l'attaquant compare statistiquement chaque état candidat de $L_1$ à la suite chiffrante captée. Le vrai état se démarque par corrélation.
...
\begin{frame}[fragile]{Visualisation de l'Attaque en Cascade}
    ...
    \begin{enumerate}
        ...
        \item Conserver la clé de $LFSR_1$ qui maximise la corrélation avec la suite chiffrante.
