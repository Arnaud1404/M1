...
\begin{frame}[fragile]{Visualisation de l'Attaque en Cascade}
    ...
    \begin{tikzpicture}[auto, thick, node distance=1.5cm and 2cm]
        ...
        \node[draw, rounded corners, fill=blue!10, text width=4.5cm, align=center, below=1.5cm of attack2] (finish) {5. État Initial Reconstruit\\ en cascade (\textbf{Clair})};
    ...
    \begin{enumerate}
        \item Capter le chiffré cible, et y associer du ``Clair probable'' (en-tête télex, salutation diplomatique).
